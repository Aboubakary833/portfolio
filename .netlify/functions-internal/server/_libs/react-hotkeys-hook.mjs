...
//#region node_modules/react-hotkeys-hook/packages/react-hotkeys-hook/dist/index.js
...
}, k = (0, import_react.createContext)(void 0), A = () => (0, import_react.useContext)(k);
function M(e, t) {
...
var N = (0, import_react.createContext)({
	...
	enableScope: () => {},
	disableScope: () => {}
}), P = () => (0, import_react.useContext)(N);
function I(e) {
	let t = (0, import_react.useRef)(void 0);
	return M(t.current, e) || (t.current = e), t.current;
}
var L = (e) => {
	e.stopPropagation(), e.preventDefault(), e.stopImmediatePropagation();
}, R = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect;
function z(e) {
	if (!e) return;
...
function B(e, n, r, i) {
	let [a, c] = (0, import_react.useState)(null), l = (0, import_react.useCallback)((e) => (c(e), () => c(null)), []), u = (0, import_react.useRef)(!1), d = Array.isArray(r) ? Array.isArray(i) ? void 0 : i : r, g = _(e) ? e.join(d?.delimiter) : e, v = Array.isArray(r) ? r : Array.isArray(i) ? i : void 0, C = (0, import_react.useCallback)(n, v ?? []), E = (0, import_react.useRef)(C);
	v ? E.current = C : E.current = n;
	let k = I(z(d)), j = (0, import_react.useRef)(d?.enabled);
	j.current = d?.enabled;
	let M = (0, import_react.useRef)(d?.preventDefault);
	M.current = d?.preventDefault;
	let N = (0, import_react.useRef)(d?.ignoreEventWhen);
